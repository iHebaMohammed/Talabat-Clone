    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(ProductViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await unitOfWork.Repository<Product>().CreateAsync(mappedProduct);
        ...
        public async Task<IActionResult> Edit(int id, ProductViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var mappedProduct = mapper.Map<ProductViewModel, Product>(model);
                unitOfWork.Repository<Product>().UpdateAsync(mappedProduct);
        ...
        public async Task<IActionResult> Delete(int id, ProductViewModel model)
        {
            ...
            try
            {
                ...
                unitOfWork.Repository<Product>().DeleteAsync(product);
                await unitOfWork.Complete();
                return RedirectToAction("Index");
